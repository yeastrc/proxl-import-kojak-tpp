...
public class MsmsPipelineAnalysis {
    ...
    @XmlElements({
        @XmlElement(name = "analysis_summary", required = true, type = MsmsPipelineAnalysis.AnalysisSummary.class),
        @XmlElement(name = "dataset_derivation", required = true, type = MsmsPipelineAnalysis.DatasetDerivation.class),
        @XmlElement(name = "msms_run_summary", required = true, type = MsmsPipelineAnalysis.MsmsRunSummary.class)
    })
